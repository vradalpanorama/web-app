...
export async function generateMetadata({ params }) {
    ...
    return {
        title: page.settings.seoAndSocial.title["en"],
        description: page.settings.seoAndSocial?.description?.en ?? "",
    };
}

export default async function SecondLevelEN({ params }) {
    const response = await sanityFetch({ params });
    ...
    return <PageBuilder page={page} lang={"en"} />;
}
